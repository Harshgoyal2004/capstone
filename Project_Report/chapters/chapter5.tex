...
\caption{MIT-BIH Arrhythmia Beat Class Distribution (109,446 total beats) --- N dominates at 72.6\%}
\label{fig:classdist}
\end{figure}
...
\begin{figure}[h!]
	\centering
	\fbox{\begin{minipage}{0.75\linewidth}\centering\vspace{1.5cm}\textit{[Figure to be inserted: ECG Preprocessing Pipeline\\Raw Signal (Top) $\rightarrow$ Bandpass Filtered (Middle) $\rightarrow$ Segmented Beat Window (Bottom)]}\vspace{1.5cm}\end{minipage}}
