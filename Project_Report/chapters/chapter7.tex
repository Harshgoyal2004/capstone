...
\end{tikzpicture}
\caption{Risk Stratification Thresholds Across All Three Deployed Models}
...
\begin{minipage}{0.48\textwidth}
  ...
  \captionof{figure}{ECGNet Confusion Matrix (5-class AAMI)}
  \label{fig:ecgcm}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/ecg_roc_curve.png}
  \captionof{figure}{ECGNet ROC Curves per AAMI Class (Macro AUROC = 0.7562)}
  \label{fig:ecgroc}
\end{minipage}
\end{figure}
...
\caption{ECGNet Training vs.\ Test Accuracy over 25 Epochs (Overfitting Gap = 38.55 pp)}
\label{fig:ecgtrain}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
  ...
  \captionof{figure}{DiabetesNet Confusion Matrix (PIDD Test Set, 154 samples)}
  \label{fig:diabcm}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/diabetes_roc_curve.png}
  \captionof{figure}{DiabetesNet ROC Curve (AUROC = 0.8170)}
  \label{fig:diabroc}
\end{minipage}
\end{figure}
...
\begin{minipage}{0.48\textwidth}
  ...
  \captionof{figure}{ParkinsonNet Confusion Matrix (UCI Test Set, 39 samples)}
  \label{fig:parkcm}
\end{minipage}\hfill
\begin{minipage}{0.48\textwidth}
  \centering
  \includegraphics[width=\linewidth]{images/parkinsons_roc_curve.png}
  \captionof{figure}{ParkinsonNet ROC Curve (AUROC = 0.9931)}
  \label{fig:parkroc}
\end{minipage}
\end{figure}
...
\caption{Model Accuracy Comparison: This Work vs.\ Best Reported Literature Results per Domain}
